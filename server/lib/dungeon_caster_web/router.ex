defmodule DungeonCasterWeb.Router do
  use DungeonCasterWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {DungeonCasterWeb.Layouts, :root}
  ...
  scope "/", DungeonCasterWeb do
    ...
    live_session :app, layout: {DungeonCasterWeb.Layouts, :app} do
      live "/", DashboardLive
